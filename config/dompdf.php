...
return [
    ...
    */
    ...
    'options' => [
        ...
        'public_path' => public_path(),  // Définit le chemin public de votre application
          'enable_remote' => true, // Permet d'accéder à des fichiers distants, si vous utilisez un serveur externe.
           'isLocalImages' => true,  // Permet l'accès aux images locales
        /**
